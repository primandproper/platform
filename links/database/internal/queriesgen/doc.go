/*
Command queriesgen writes the canonical sqlc input for the action link schema,
one file per dialect, from links/database/internal/queries.
...
links/database/migrations renders, at build time, with no database running.
