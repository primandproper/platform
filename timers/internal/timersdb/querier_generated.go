...
type Querier interface {
	...
	// ClaimDueTimers runs the :many query.
	ClaimDueTimers(ctx context.Context, db DBTX, arg ClaimDueTimersParams) ([]ClaimDueTimersRow, error)
	...
	// ReapFiredTimers runs the :execrows query.
	//
	// The count means different things on different engines; see the note
	// on Querier.
	ReapFiredTimers(ctx context.Context, db DBTX, arg ReapFiredTimersParams) (int64, error)
	// ReleaseTimers runs the :execrows query.
	//
	// The count means different things on different engines; see the note
	// on Querier.
	ReleaseTimers(ctx context.Context, db DBTX, arg ReleaseTimersParams) (int64, error)
	// ScheduleTimers runs the :exec query.
	ScheduleTimers(ctx context.Context, db DBTX, arg ScheduleTimersParams) error
}
