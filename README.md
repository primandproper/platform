...
[![Go Reference](https://pkg.go.dev/badge/github.com/primandproper/platform-go/v9.svg)](https://pkg.go.dev/github.com/primandproper/platform-go/v9) [![codecov](https://codecov.io/github/primandproper/platform-go/graph/badge.svg?token=69RLLWLJ39)](https://codecov.io/github/primandproper/platform-go)
...
```bash
go get github.com/primandproper/platform-go/v9@latest
```
