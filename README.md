...
[![Go Reference](https://pkg.go.dev/badge/github.com/primandproper/platform-go/v12.svg)](https://pkg.go.dev/github.com/primandproper/platform-go/v12) [![codecov](https://codecov.io/github/primandproper/platform-go/graph/badge.svg?token=69RLLWLJ39)](https://codecov.io/github/primandproper/platform-go)
...
**Module:** `github.com/primandproper/platform-go/v12`
**Go:** 1.26
...
```bash
go get github.com/primandproper/platform-go/v12@latest
```
