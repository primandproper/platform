...
[![Go Reference](https://pkg.go.dev/badge/github.com/primandproper/platform-go/v7.svg)](https://pkg.go.dev/github.com/primandproper/platform-go/v7) [![codecov](https://codecov.io/github/primandproper/platform-go/graph/badge.svg?token=69RLLWLJ39)](https://codecov.io/github/primandproper/platform-go)
...
**Module:** `github.com/primandproper/platform-go/v7`
**Go:** 1.26
...
```bash
go get github.com/primandproper/platform-go/v7@latest
```
