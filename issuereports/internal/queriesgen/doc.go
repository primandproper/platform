/*
Package main renders the canonical sqlc input for the issue reports table, one
.sql per dialect, from the table description in
issuereports/internal/queries.

It is run by `go generate ./issuereports/...` and by CI's generated-files check,
