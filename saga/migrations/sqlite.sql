...
-- looks at them.
CREATE INDEX IF NOT EXISTS {{PREFIX}}_instances_claim_idx
    ON {{PREFIX}}_instances (next_attempt, started_at, id)
...
CREATE INDEX IF NOT EXISTS {{PREFIX}}_instances_status_idx
